...
void Update_Action_gl_position(float value[6])
{
	...
	//变换到底盘中心 !待调参
	ROBOT_CHASSI.world_x = ACTION_GL_POS_DATA.REAL_X + INSTALL_ERROR_X * sin(ROBOT_CHASSI.world_w * PI / 180);
	ROBOT_CHASSI.world_y = ACTION_GL_POS_DATA.REAL_Y + INSTALL_ERROR_Y * cos(ROBOT_CHASSI.world_w * PI / 180);
}
