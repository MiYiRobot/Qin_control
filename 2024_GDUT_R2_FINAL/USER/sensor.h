...
#define Write_Add 0x90
#define HSL_order 0xD1
#define Read_Add 0x91
...
extern COLOR_RECOGNITION enter_ball;
extern COLOR_RECOGNITION out_ball;
extern COLOR_RECOGNITION middle_ball;
...
void read_huidu(void);
void Huidu_Sensor(void);
void ball_recognition(COLOR_HSL* front_hsl,COLOR_HSL* back_hsl);
void tcs34725_work(void);
void yanse_init(void);
void yanse_read1(void);
void yanse_read2(void);
void yanse_read(void);
